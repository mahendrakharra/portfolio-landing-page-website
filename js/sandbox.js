      ...
      const newDrop = document.querySelector("#new-drop");
      const extraOne = document.querySelector(".hide");
      const extraTwo = document.querySelector(".hide-two");
            newDrop.addEventListener("click", e => {
                extraOne.classList.toggle("show");
                extraTwo.classList.toggle("show");
            });
